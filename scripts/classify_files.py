...
"Decide whether the FILE ITSELF is a Japanese translation (和訳/訳註/訳注/全訳/現代語訳) of a classical INDIAN Buddhist text "
...
"If the file is NOT itself such a translation (a study/article ABOUT a text, a modern work, a Chinese/Japanese indigenous text, "
...
if __name__=="__main__":
    files=[l.rstrip("\n") for l in open("/tmp/claude-1000/mj_filenames.txt") if l.strip()]
    ...
    with open("/tmp/claude-1000/mj_file_works.tsv","w",encoding="utf-8") as f:
        for b in res:
